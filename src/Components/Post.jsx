            ...
            <div className="Listings--Posts--Details">
                ...
                <div className="Listings--Posts--Details-Info">
                    <div className="Listings--Posts--Details--Top">
                        ...
                        {news ? <div className="Listings--Post--Details--New-Bubble"> <h2 className="Listings--Post--Details--New">NEW!</h2> </div> : null}
                        {featured ? <div className="Listings--Post--Details--Featured-Bubble"> <h2 className="Listings--Post--Details--Featured">FEATURED</h2> </div> : null}
                    </div>
                    ...
                    <div className="Listings--Posts--Details--Bottom">
                        <h3 className="Listings--Posts--Detials--Time">{posted} </h3> <span> · </span>
                        <h3 className="Listings--Post--Details-Contract">{contract} </h3> <span> · </span>
